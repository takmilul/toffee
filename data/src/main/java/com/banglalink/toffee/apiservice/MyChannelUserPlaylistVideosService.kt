...
class MyChannelUserPlaylistVideosService @AssistedInject constructor(
    ...
    override suspend fun loadData(offset: Int, limit: Int): List<ChannelInfo> {
        ...
        val response = tryIO2 {
            toffeeApi.getMyChannelUserPlaylistVideos(
                ...
                limit, offset,
                preference.getDBVersionByApiName(ApiNames.GET_UGC_MY_CHANNEL_USER_PLAYLIST_VIDEOS),
    ...
    interface AssistedFactory {
        fun create(requestParams: MyChannelPlaylistContentParam): MyChannelUserPlaylistVideosService
    }
}