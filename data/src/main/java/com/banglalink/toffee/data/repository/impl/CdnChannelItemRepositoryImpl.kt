...
class CdnChannelItemRepositoryImpl (private val dao: CdnChannelItemDao): CdnChannelItemRepository {
    ...
    override suspend fun updateCdnChannelItemByChannelId(channelId: Long, expiryDate: String?, payload: String): Int? = dao.updateCdnChannelItemByChannelId(channelId, expiryDate, payload)
