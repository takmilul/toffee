...
@AndroidEntryPoint
class TrendingChannelsEditorsChoiceFragment: HomeBaseFragment(), ProviderIconCallback<ChannelInfo> {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_trending_channels_editors_choice, container, false)
    }
