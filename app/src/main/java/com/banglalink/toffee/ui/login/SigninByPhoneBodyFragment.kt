...
import com.banglalink.toffee.databinding.FragmentSigninByPhoneBodyBinding
...
import kotlinx.android.synthetic.main.fragment_signin_by_phone.*
import kotlinx.android.synthetic.main.fragment_verify_signin.*

class SigninByPhoneBodyFragment : Fragment() {

    lateinit var binding: FragmentSigninByPhoneBodyBinding
    ...
    companion object {
        @JvmStatic
        fun newInstance() =
            SigninByPhoneBodyFragment()
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_signin_by_phone_body, container, false)
        return binding.root
    }
...
//        progressDialog.show()
        ...
        val referralCode = binding.refCodeEt.text.toString()
        val regSessionToken = ""
        findNavController().navigate(
            SigninByPhoneBodyFragmentDirections.actionSigninByPhoneBodyFragment2ToVerifySigninFragment2(phoneNumber, referralCode, regSessionToken)
        )
