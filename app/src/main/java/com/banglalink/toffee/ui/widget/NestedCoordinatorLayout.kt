...
class NestedCoordinatorLayout : CoordinatorLayout, NestedScrollingChild {
    ...
    override fun onStartNestedScroll(child: View, target: View, nestedScrollAxes: Int): Boolean {
        ...
        return startNestedScroll(nestedScrollAxes) || tHandled // Enable the scrolling behavior of the parent's other children
    }
    
    override fun onStopNestedScroll(target: View) {
        /* Disable the scrolling behavior of our own children */
        super.onStopNestedScroll(target)
        stopNestedScroll() // Disable the scrolling behavior of the parent's other children
    }
