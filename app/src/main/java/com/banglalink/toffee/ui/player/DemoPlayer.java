...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public DemoPlayer(Context mContext, RendererBuilder rendererBuilder){
  ...
  public void onBandwidthSample(int elapsedMs, long bytes, long bitrateEstimate) {
    if (infoListener != null) {
      Log.e("onBandwidth", "" + elapsedMs + ", " + bytes + ", " + bitrateEstimate);
...
//        Toast.makeText(mContext,"" + videoFormat.width + "x" + videoFormat.height,Toast.LENGTH_SHORT).show();
      }
    } else if (sourceId == TYPE_AUDIO) {
      infoListener.onAudioFormatEnabled(format, trigger, mediaTimeMs);
      if(format != null )
      Toast.makeText(mContext,"bitrate " + format.bitrate, Toast.LENGTH_SHORT).show();
    }
  }
