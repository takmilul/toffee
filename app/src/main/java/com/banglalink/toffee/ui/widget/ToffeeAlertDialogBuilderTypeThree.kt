...
data class ToffeeAlertDialogBuilderTypeThree(
        var context: Context,
        ...
        private lateinit var binding: VelboxDialogLayoutTypeThreeBinding
        ...
        fun create(): AlertDialog {
            val dialogBuilder = AlertDialog.Builder(context).apply {
                binding = VelboxDialogLayoutTypeThreeBinding.inflate(LayoutInflater.from(context), null, false)
