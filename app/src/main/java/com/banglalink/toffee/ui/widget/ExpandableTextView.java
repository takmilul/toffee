...
public class ExpandableTextView extends AppCompatTextView
{
    ...
    private void recalculateTextHeight() {
        // measure collapsed height
        this.setMaxLines(Integer.MAX_VALUE);
        this.measure
                (
        ...
        int expHeight = this.getMeasuredHeight();
        ...
        int colHeight = this.getMeasuredHeight();

        if(this.onExpandListeners != null) {
            if (expHeight != colHeight) {
                for (final OnExpandListener onExpandListener : this.onExpandListeners) {
                    onExpandListener.onControllerVisibility(this, true);
                }
            } else {
                for (final OnExpandListener onExpandListener : this.onExpandListeners) {
                    onExpandListener.onControllerVisibility(this, false);
                }
            }
        }
    }
    ...
    public interface OnExpandListener
    {
        ...
        void onControllerVisibility(@NonNull ExpandableTextView view, boolean show);
    }
    ...
    public static class SimpleOnExpandListener implements OnExpandListener
    {
        ...
        @Override
        public void onControllerVisibility(@NonNull ExpandableTextView view, boolean show) {
            // empty implementation
        }
    }
