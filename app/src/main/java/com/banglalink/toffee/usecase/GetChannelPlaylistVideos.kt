...
class GetChannelPlaylistVideos(private val toffeeApi: ToffeeApi, private val contentRequest: ContentRequest, private val category: String, private val subCategory: String): SingleListRepository<ChannelInfo> {
